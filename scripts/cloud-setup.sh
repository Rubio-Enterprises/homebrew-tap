...
# on the web "Setup script" for homebrew-tap's cloud environment.
#
...
CACHE_EPOCH=1
export CACHE_EPOCH
for d in "${CLAUDE_PROJECT_DIR:-}" "$PWD" /home/user/homebrew-tap; do
...
echo "cloud-setup: building homebrew-tap environment cache (epoch ${CACHE_EPOCH:-unset})" >&2
